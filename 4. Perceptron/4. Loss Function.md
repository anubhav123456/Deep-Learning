...
The Perceptron uses a simple **0–1 loss**:
...
* Prediction is correct → **Loss = 0**
* Prediction is wrong → **Loss = 1**

Every mistake is penalized equally with a value of **1**.

---

# 4. Example

| Actual ((y)) | Predicted ((\hat{y})) | Loss |
| -----------: | --------------------: | ---: |
|            1 |                     1 |    0 |
|            1 |                     0 |    1 |
|            0 |                     1 |    1 |
...
So, the Perceptron simply counts the number of incorrect predictions.

---

# 5. Indicator Function Notation

Instead of writing the loss using an if-else statement, we use an **indicator function**:

[
L=\mathbf{1}_{(y\ne\hat y)}
]

### Meaning of the indicator function
...
It is simply a compact mathematical way of writing the same 0–1 loss.

---

# 6. Purpose of the Loss Function
...
# 8. Comparison with Squared Error Loss
...
# 9. Why Are They Equivalent Here?
